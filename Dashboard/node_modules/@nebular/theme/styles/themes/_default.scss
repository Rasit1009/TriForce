...
$theme: (
  ...
  blueshadow: 0 0 12px #009fe3, // 0 2px 12px 0  #dfe3eb,
  ...
  linear-gradient:  -webkit-linear-gradient(to right, #009fe3 5%, #ff2430),
  ...
  menu-bg: color-bg,
  menu-active-fg: #009fe3, //color-fg-heading,
  ...
  menu-icon-margin: 0 1.5rem 0 0,
  menu-icon-color: color-fg,
  menu-icon-active-color: #009fe3, //color-fg-heading,
